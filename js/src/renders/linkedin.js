...
export const linkedin = () => {
  ...
  const id = document.getElementById("linkedin");
  const scene = new THREE.Scene();

  const camera = new THREE.PerspectiveCamera(1, 130 / 130, 10, 100);
  ...
  const loaderElement = document.querySelector("#linkedin .loader");

  let objModel;
  loader.load("./js/src/models/linkedin.glb", (gltf) => {
    objModel = gltf.scene;
