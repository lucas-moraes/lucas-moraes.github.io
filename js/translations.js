export const translations = {
  ...
  br: {
    ...
    "project-description-whatzator":
      "Permite iniciar conversas no WhatsApp Web sem a necessidade de salvar o número na lista de contatos. Desenvolvida utilizando html, css e javascript, a extensão oferece uma interface intuitiva e fácil de usar, permitindo que os usuários enviem mensagens rapidamente para qualquer número de telefone.",
